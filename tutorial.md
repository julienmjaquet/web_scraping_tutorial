...
For the purpose of this tutorial, we are going to retrieve data from Wikipedia. More specifically, we are going to retrieve the table of all [Swiss municipalities](https://de.wikipedia.org/wiki/Liste\_Schweizer\_Gemeinden]). <br/>
